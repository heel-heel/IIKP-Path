...
param_dist = {
    'hidden_layer_sizes': [(20,), (50,), (80,), (100,), (200,), (50, 20), (100, 50), (100, 100), (50, 20, 20), (100, 50, 20)],
...
if __name__ == "__main__":
    ...
    for dataset, columns in datasets.items():
        ...
        for pattern in Mechanism:
            ...
            output_results_file = os.path.join(output_base_path, "classification", dataset, pattern, f"mlp-imputation-results-{dataset}.csv")
