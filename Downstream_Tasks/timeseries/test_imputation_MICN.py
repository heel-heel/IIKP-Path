...
for dataset, columns in datasets.items():
    ...
    for pattern in Mechanism:
        ...
        for method in Imputation_Algorithms:
            for rate in Missing_rate:
                ...
                x_enc_imp, x_mark_enc_imp, x_dec_imp, x_mark_dec_imp, y_imp = create_micn_dataset(
                    scaled_features_imp, seq_len, label_len, pred_len, dataset
                )
                ...
                predictions_imp = train_micn_model(
                    dataset, x_enc_train_imp, y_train_imp, x_enc_test_imp, y_test_imp,
        ...
        output_results_file = os.path.join(output_results_path, f"micn-imputation-results-{dataset}.csv")
