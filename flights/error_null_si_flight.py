...
def process_and_fill_csv(file_name, output_file_name):
    ...
    #print(missing_mask)
    missing_mask_V2 = missing_mask[:, 1]
    X_filled[missing_mask_V2] = 0
    ...
    for threshold in thresholds:
        ...
        for _ in range(max_iter):
            ...
            # 更新V2列的缺失值
            X_filled[missing_indices, 1] = X_imputed[missing_indices, 1]
    ...
    for index in missing_indices:
        generated_value = best_filled[index, 1]
        #print("-----------")
...
for rate in Missing_rate:
    ...
    output_file = f'dirty-flight-si-{rate}.csv'
