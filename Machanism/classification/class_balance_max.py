...
for dataset, columns in datasets.items():
    input_path = os.path.join(base_path, dataset, "Machanism", "classification", "discriminability_precision")
    output_path = os.path.join(base_path, dataset, "Machanism", "classification", "class_balance")
